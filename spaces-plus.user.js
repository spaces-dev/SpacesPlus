...
exports.getClassName = (data, t) => {
    ...
    for (let node of nodes) {
        if (node.className.indexOf(str[1]) !== -1 && !t) {
            list.push(node);
        }
